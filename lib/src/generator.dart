  ...
  GenerationOutput generate(
    ...
    return GenerationOutput({
      'program.dart': _library(
        ...
        const [],
        exports: const [
          '__PROGRAM_STEM__.solana.support.dart',
          '__PROGRAM_STEM__.solana.types.dart',
          '__PROGRAM_STEM__.solana.accounts.dart',
          '__PROGRAM_STEM__.solana.instructions.dart',
          '__PROGRAM_STEM__.solana.resolution.dart',
          '__PROGRAM_STEM__.solana.events.dart',
          '__PROGRAM_STEM__.solana.errors.dart',
          '__PROGRAM_STEM__.solana.client.dart',
        ],
      ),
      ...
      'types.dart': _library(
        ...
        const ['dart:typed_data', '__PROGRAM_STEM__.solana.support.dart'],
        sections['types']!,
      ),
      ...
      'errors.dart': _library(
        ...
        const ['__PROGRAM_STEM__.solana.support.dart'],
        sections['errors']!,
      ),
